...
import usePageDetail from "./usePage";

interface Props {
  params: { id: string };
}
const ChatDetail: React.FC<Props> = (props) => {
  const {
    handleKeyDown,
    handleTyping,
    handleSubmit,
            ...
            <div className="flex flex-col h-full overflow-x-auto mb-4">
              <div className="flex flex-col h-full">
                <div className="grid grid-cols-12 gap-y-2">
                  {listMessage && Array.isArray(listMessage) && listMessage.map((value) => {
                    if (value.type == TYPE_CHAT.FROM) {
                      return (
                        <div
                    ...
                    } else if (value.type == TYPE_CHAT.TO) {
                      return (
                        <div
